...
class TNT2: public Unit{//TNT is inheriting from unit class
...
public:
    ...
    void delete_TNT2(int,int); // this deletes TNT as soon as it hits a tank
    TNT2(); //default constructor
    TNT2(int x, int y);   // parametrized constructor
